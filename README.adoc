...
While Buildah is designed specifically for building container images, Podman further incorporates functionality to maintain those images, 
in addition to the creation and running of containers. Podman uses Buildah's functionality to create the container image it uses.
