...
`full` images are recommended for development only since they significantly expand the image size with features that are not required by the application.
